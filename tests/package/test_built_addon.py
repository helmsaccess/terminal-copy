...
class TestBuiltAddon(unittest.TestCase):
	...
	def testLocalizedRuntimeContentIsUsable(self) -> None:
		...
		self.assertIn("updateChannel = dev", baseManifest)
		...
		self.assertIn("TDSR by Tyler Spivey and Speakup", baseManifest)
		self.assertIn("TDSR von Tyler Spivey und Speakup", germanManifest)
		self.assertIn("https://github.com/tspivey/tdsr", baseManifest)
		self.assertIn("https://github.com/linux-speakup/speakup", germanManifest)
